# Seo Content Launch Workflow

## Purpose
Use for search-focused content. Separate verified facts from assumptions, avoid stuffing, include metadata, links, page speed, and trust review.
