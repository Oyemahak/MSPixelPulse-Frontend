  ...
  return (
    <figure className="agency-interface-preview">
      <div className="agency-collaboration-frame">
        <picture>
          <source media="(max-width: 720px)" srcSet="/hero/mspixelpulse-web-design-collaboration-720.webp" />
          <source media="(max-width: 1080px)" srcSet="/hero/mspixelpulse-web-design-collaboration-1080.webp" />
          <img
            className="agency-collaboration-image"
