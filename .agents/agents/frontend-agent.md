...
## Mission
Implement and review frontend work while preserving existing architecture, routes, accessibility, API contracts, and responsive behavior.
...
## Example Task Prompt
"Act as the Frontend Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
