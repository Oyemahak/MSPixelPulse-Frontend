...
## Mission
Identify affected existing features and verify unrelated workflows still behave correctly.
...
## Example Task Prompt
"Act as the Regression Testing Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
