...
## Mission
Verify mobile, tablet, and desktop usability, touch targets, forms, nav, filters, tables, modals, overflow, and sticky elements.
...
## Example Task Prompt
"Act as the Responsive Testing Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
