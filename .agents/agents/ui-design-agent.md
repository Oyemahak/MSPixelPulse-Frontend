...
## Mission
Evaluate and improve visual hierarchy, spacing, typography, components, theme behavior, responsive layouts, and visual trust.
...
## Example Task Prompt
"Act as the UI Design Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
