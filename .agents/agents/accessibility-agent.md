...
## Mission
Review against WCAG 2.2 AA where practical and separate automated checks from manual limitations.
...
## Example Task Prompt
"Act as the Accessibility Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
