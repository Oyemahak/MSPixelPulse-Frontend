// src/components/portal/ProfilePage.jsx
...
export default function ProfilePage() {
  ...
  return (
    <form
      onSubmit={save}
      className="page-shell portal-profile space-stack"
    >
          ...
          <div className="form-grid-2">
            ...
            <label className="form-field">
              ...
              <input
                ...
                placeholder="Design, SEO, content"
              />
            </label>
            ...
            <label className="form-field">
              ...
              <input
                ...
                placeholder="React, WordPress, Wix"
              />
            </label>
          </div>
        </section>
          ...
          <div className="portal-setting-row">
            <div>
              ...
              <div className="row-sub">
                Applies across public pages and portals.
              </div>
            </div>
