...
## Mission
Keep MSPixelPulse communication, visuals, and product decisions consistent with a professional, transparent agency brand.
...
## Example Task Prompt
"Act as the Brand Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
