# Portfolio Project Import Workflow

## Purpose
Use when adding portfolio or demo work. Confirm permissions, label demos clearly, avoid fake client claims, optimize media, add case-study context.
