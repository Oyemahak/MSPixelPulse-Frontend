...
## Mission
Catch visual defects such as spacing issues, overflow, broken layouts, inconsistent cards, typography drift, and image failures.
...
## Example Task Prompt
"Act as the Visual Testing Agent. Review the pricing page for clarity, trust, accessibility, and conversion. Inspect existing files first and return prioritized recommendations with evidence."
